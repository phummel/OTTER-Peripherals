...
#Pmod Header JXADC
#Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {ANALOG_POS}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {ANALOG_POS}]
#Sch name = XA2_P
...
#Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {ANALOG_NEG}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {ANALOG_NEG}]
#Sch name = XA2_N
